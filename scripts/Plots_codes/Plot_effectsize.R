...
###############################################################
for (i in 5:9){
  data_out <- read_excel(paste0("results/Simulation_effect_sd0",i,".xlsx"))
  # colnames(data_out)
  ...
  ggsave(paste0("results/Plots/plot_effect_size_sd0",i,".jpeg"), final_plot, width = 190, height = 196, units = "mm", dpi = 600)
