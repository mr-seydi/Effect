...
###############################################################
data_max1_SD1half <- read_excel("results/Simulation1_SD1half_out.xlsx")
data_SqP_SD1half <- read_excel("results/Simulation_SqP1_SD1half.xlsx")
data_GP1_SD1half <- read_excel("results/Simulation_GP1_SD1half_out.xlsx")
...
PS_1_SPM <- power_plot_SPM(data_max1_SD1half,Title="",Ylim=c(0,1))
PS_1_SnPM <- power_plot_SnPM(data_max1_SD1half,Title="",Ylim=c(0,1))
PS_3_SPM <- power_plot_SPM(data_SqP_SD1half,Title="",Ylim=c(0,1))
PS_3_SnPM <- power_plot_SnPM(data_SqP_SD1half,Title="",Ylim=c(0,1))
PS_9_SPM <- power_plot_SPM(data_GP1_SD1half,Title="",Ylim=c(0,1))
PS_9_SnPM <- power_plot_SnPM(data_GP1_SD1half,Title="",Ylim=c(0,1))
...
legend_plot <- power_plot_SPM(data_max1_SD1half, Title = "", legend = "bottom")
...
ggsave("results/Plots/plot_Max1_SD1half.jpeg", final_plot, width = 190, height = 196, units = "mm", dpi = 600)
