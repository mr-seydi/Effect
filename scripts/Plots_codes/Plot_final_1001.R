...
###############################################################
data_1 <- read_excel("results/Simulation1_1001.xlsx")
data_3_1 <- read_excel("results/Simulation_SqP1_1001_part1.xlsx")
data_3_2 <- read_excel("results/Simulation_SqP1_1001_part2.xlsx")
data_3 <- rbind(data_3_1,data_3_2)

data_9 <- read_excel("results/Simulation_GP1_1001.xlsx")
...
Pulse_long_two_square <- data.frame(Domain = 0:1000, Pulse_two_square) %>%
...
# Convert to data frame and reshape
Pulse_long <- data.frame(Domain = 0:1000, Pulse) %>%
  pivot_longer(-Domain, names_to = "Curve", values_to = "Effect")
# Add a curve order column based on the column order in the matrix
...
# Convert to data frame and reshape
Pulse_long_GP <- data.frame(Domain = 0:1000, Pulse_G) %>%
  pivot_longer(-Domain, names_to = "Curve", values_to = "Effect")
# Add a curve order column based on the column order in the matrix
...
ggsave("results/Plots/plot_final_1001.jpeg", final_plot, width = 190, height = 196, units = "mm", dpi = 600)
