...
print(final_plot)
#ggsave("Outputs/PaperPlots/Plot_RealData.jpeg", final_plot, width = 190, height = 120, units = "mm", dpi = 1200)
#ggsave("Outputs/PaperPlots/Plot_RealData.tiff", final_plot, width = 190, height = 120, units = "mm", dpi = 1200, device = "tiff")
